...
Updated 2026-09-06. Build 0.1.3. Source tree at C:\workspace\UntangleIt. Publisher `prs`, extension id `prs.untangleit`.
...
npx @vscode/vsce package --no-dependencies      # untangleit-0.1.3.vsix
```
...
2. DeepTest 0.3.7: route "Break it into smaller pieces" to `untangleit.method` when UntangleIt is installed, and remove the refactor brief from DeepTest.
